...
public class DiceAdapter2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyListAdapter myListAdapter = new MyListAdapter(arrText);
    ...
    private class MyListAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LayoutInflater inflater = DiceAdapter2.this.getLayoutInflater();
